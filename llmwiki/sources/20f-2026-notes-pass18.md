...
当期税のSFPネット（未払−未収）: FY2025 288,972 / FY2026 476,250。貸借対照として注記16(2)の当期税費用FY2026 1,472,925がある。編成書のキャッシュ・アウトフローに「Income taxes paid, net of refunds」があるが、本パスでは金額引用しない（親パスのCF表と重複し得るため。次嬉に残す）。
...
財政状態計算書上、相殺要件を満たして実際に相殺した額はimmaterial、と注記22末尾。相殺対象の科目はデリバティブのみ。貨借・金融債権・社債の相殺行は注記22に無い。
