...
## 教材で押さえる要素（FY2026追記・pass35）
| 要素 | TMCでの出方 |
|---|---|
| 重要事実の数値例（Exhibit 19.1） | 災害損害は純資産3%。提携は売上年10%またはJV資産×持分が純資産30%。増資総額1億円。配当増減20%。分割増加10% |
| 公表 | 社内は媒体発表・TDnet・EDINETのいずれかから24時間。金商法の媒体ルートは12時間 |
| Item 6.F | FY2026は None |
| Exhibit 97.1 | FY2024 20-F参照組込み。採択 2023-11-29。運用は Executive Compensation Meeting。無過失。補償禁止。発効前受領は対象外 |
...
羽村移管後法人の資本金・人員・敷地は日野短信の「精査中」額と別物。法人公式は[[sources/hino-ir-pass8]]。半期報提出時の新会社資本金は1円（[[sources/hino-ir-pass11]]）。
