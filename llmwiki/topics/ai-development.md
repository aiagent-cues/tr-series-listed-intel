...
- GAIAは「10カテゴリー」（拡大検討）。列挙: AD/ADAS、AIエージェント、モビリティ3.0、ソフトウェア効率化、ノウハウ伝授、材料設計、製造、業務効率化、ロボティクス、車両設計。IRの「11カテゴリー」との差はカスタマーリレーション。文書と更新月が違うため両方残す。
...
## 統合報告2025 第5パス（SDV基盤・Arene・e-Palette）
出典: [[sources/integrated-report-2025-pass5]]（2026-09-07 04:03 JST、IR p78-87）。
- 2030年に必要通信量は現比22倍、計算量は150倍（当社試算、p79）。
- NTTとモビリティAI・通信の共同取組合意 2024-10。IOWNを分散DCに活用。標準化を視野。
- モビリティAI基盤の3要素: 分散計算資源 / 次世代通信 / AI基盤。
- Arene 3構成: SDK / Tools / Data。新型RAV4が量産第一歩（p80-83）。
- e-Palette販売 2025-09。Arena Tokyo・Woven Cityから導入。レベル4準拠の市場導入目標は2027年度（p86）。
- ソフト一体組織 2023-10。トヨタソフトウエアアカデミー 2025-05（アイシン・デンソー・豊田通商・TMC・Woven）。

## 統合報告2025 第7パス（OMUSVI）
出典: [[sources/integrated-report-2025-pass7]]（2026-09-07 05:11 JST、印刷p154）。
- Organized Master Unified System for Vehicle Information。車両仕様書の共通言語化と双方向実時共有。
- 既往: 企画は手書き無制限、製造は200桁アルファベット、営業は80桁、販売店はカタログ。
- 期待: 読み替え廃止、生産仕様数の絞り込み、部品・金型減、LT短縮、仕入先負担軽減。数値ターゲットは未掲。
- 共通言語+AIで地域ニーズの需給を実時分析すると本文。コーポレート一気通貫DXの一テーマ。
