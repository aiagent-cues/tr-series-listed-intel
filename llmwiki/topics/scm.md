...
- LNG燃料自動車運搬船を東南アジア航路で2025年2只運航開始。
...
- NiMH: トヨタHV引取受付センター、2024年度4万台。
- LiB: 一般社団法人自動車再資源化協力機構を通じた共同回収。
- スイープ蓄電: 異種・異劣化電池の混用、変換装置簡素化、稼働中交換。JERAと長期実証。2025-08にマツダ本社内電力システムへ接続実証開始。
- 直接破砕リサイクル（非焙焼）で希少金属に加え電解液を回収。CO2と回収率の定量値は本冊に無い。
