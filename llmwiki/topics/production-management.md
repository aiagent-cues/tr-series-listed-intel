...
sources:
  ...
  - https://global.toyota/jp/detail/629964
...
- 目的は効率化ではなく「誰かの仕事を楽にしたい」。生産性向上は異常管理の結果。
- G型織機の异常: 絲がなくなる / 絲が切れる。センサーのない時代に検知し自動停止。
- JITの鍵はリードタイム。年間約1,000万人のお客様を事前把握できないため、異常が分かり止まる構造が必要。
- 自働化は仕事者の気持ちに成り代わる「ヒト中心」と定義。
...
## 工場環境・循環（SDB 2026-06 叙事）
出典: [[sources/sdb-2026-env-narrative]]（2026-09-06 22:50 JST）。
- ISO 14001: TMCおよび連結子会社の生産拠点 124社（2025年取得）。目標共有は連結527社+連結外車両生産8社。
- 社内ESCO（製造・製造技術・原動力）。田原工場の2025年度向けカーボンクレジット償却は 33 kt-CO2e（FSC森林企画のみ）。
- Toyota Circular Factory を英Burnaston製造工場内に2025-03設立。TMMUKは年間約1万台の廃車処理見込み。
- タイ固定式BESS 0.63MWh（2025-03）。TMTの水削減 183,149 m³、TMMIN 2,250 m³（2025年、排水リサイクルで排水ゼロを掲げる事例）。
- 物理リスクスクリーニング: 国内137+海外73拠点。影響は「小」。

## 工場CN機器（SDB 2026-06 p33-36）
出典: [[sources/sdb-2026-env-plant]]（2026-09-06 23:15 JST）。
- 国内レクサス車両生産の再エネ電力100%（購入電力ベース、2025年度）: 元町・田原・トヨタ車体吉原・トヨタ東日本岩手・トヨタ九州宮田。
- 田原オンサイト再エネ13%。陸上風力 21.5 MW（4.3×5）で工場需要の15%以上。テストコース太陽光とカーポート各11.1 MW。液体水素タンク 78 kL/基。鋳造保持炉の水素利用は2025年開始。
- 明知換気適正化 115 t-CO2/年、三ケ日電気式ヒートポンプ 111 t-CO2/年（2025年度）。TMT太陽光 30.4 MW。
- TMUK Deesideの廃棄物由来バイオメタン工場は2026年稼働予定（120 kt/年）。本社工場水電解の大規模実証は2026-05。LNG燃料PCCは2025年2只。
- 工場CN定義は削減しきれなかった分をクレジットで相殺。CO2ゼロとは別段階。
...
## 国内工場の一次事例（IR2025 p50-54, p62）
出典: [[sources/integrated-report-2025-pass4]]（2026-09-06 22:24 JST）。
- 高尻: 国内初BEV専用ライン。シール穴約30カ所のロボット化、電ビラ、AMR、THDSで歩行約15km→約2.7km。工場長 森田。
- 上郷: ピストンサブラインを2025-01に全面ロボット化（3人→0）。2008年部分導入の後、海外展開時は保全技能不足で一時手作業復帰。共創ラインは2024年開始。工場長 斉藤。
...
9. BEV専用ラインとエンジン工場の同時進化（高尻THDS / 上郷自働化）
10. 工場CNは省エネ→再エネ→クレジットの順（田原33 ktは減らない分の償却）
...
- 従来蓄電は電池と接続先が限定。スイープはダイレクト接続・接続先非限定と図示。
- マツダ本社への接続実証は2025-08。JERA実証が先行。
- LiBは焼却から直接破砕へ移行中。電解液回収が可能になったと本文。
