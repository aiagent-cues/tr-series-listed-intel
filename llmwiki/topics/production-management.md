...
- 田原オンサイト再エネ13%。陸上風力 21.5 MW（4.3×5）で工場需要の15%以上。テストコース太陽光とカーポート各1.1 MW。液体水素タンク 78 kL/基。鋳造保持炉の水素利用は2025年開始。
- 明知換気適正化 115 t-CO2/年、三ケ日電気式ヒートポンプ 111 t-CO2/年（2025年度）。TMT太陽光 30.4 MW。
- TMUK Deesideの廃棄物由来バイオメタン工場は2026年稼働予定（120 kt/年）。本社工場水電解の大規模実証は2026-05。LNG燃料PCCは2025年2隻。
...
- 高岢: 国内初BEV専用ライン。シール穴約30カ所のロボット化、電ビラ、AMR、THDSで歩行約15km→約2.7km。工場長 森田。
...
9. BEV専用ラインとエンジン工場の同時進化（高岢THDS / 上郷自働化）
