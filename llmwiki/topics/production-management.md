...
- TMUK Deesideの廃棄物由来バイオメタン工場は2026年稼働予定（120 kt/年）。本社工場水電解の大規模実証は2026-05。LNG燃料PCCは2025年2隻運航開始（叙事p34）。
- 工場CN定義は削減しきれなかった分をクレジットで相殺。CO2ゼロとは別段階。

## 第7次プラン残行（SDB 2026-06 p69-71）
出典: [[sources/sdb-2026-env-plan-review]]（2026-09-07 14:11 JST）。
- 物流No.5: 日本国内CO2は2018年比5%減で未達。日本↔他地域のLNG運搬船切替は目標2隻に対し‥2025年度実績3隻。航路2隻運航開始（p34）とは層が違う。
- 廃車モデル施設: 目標15ヵ所 → 22ヵ所。
- 環境異常（GRI 306-3）: 生産8件（日本3/他地域5）、非生産2件（日本2）。対策完了。重大法令違反なし。
- 第8次: 台当たり工場廃棄物・取水を2019年度以下。電池生産会社の連結化で水使用量増と注記。
