...
## 2026-09-08 JST 18:23 タイムボックス（1h分）
- 選定テーマ: 優先(1) 統合報告2025。登録頁に2026未掲。2026_001 日英とも404。日PDF HEAD不変（35,488,119 / Last-Modified 2026-04-03 02:00:02 GMT / ETag 6f429b141f4b80d241e2ebd43b35c08f-7 / S3 H0V.jlEk4DcD64PpuCNSCAcT5bg0nluM）。英 32,257,390 / 同日。TCFD円額未掲。(2) SDB sdb26_jp HEAD不変（11,691,278 / 2026-06-29 04:00:04 GMT）。sdb27 / sdb26_jp_09 は404。9月定例未掲。
- 実施: (3) 20-F/Aは404。英登録頁 Amendment 列は No。(4) toyota.com.au は403。(5) 日野ニュース09-08なし。未転記だったFY2025有報（提出 2025-06-24）の工場別PPEとHINO REPORT第113期の事業所一覧を一次抽出。時点は2025-03-31（羽村移管前）。
- 新事実の核: 提出会社合計列は日野工場 18,669 / 羽村 38,237 / 新田 33,036 / 古河 41,678（百万円）。土地面積は178 / 750 / 567 / 849千㎡。従業員 4,419 / 3,087 / 2,293 / 1,502。羽村土地750千㎡は移管後公式敷地と一致。国内子会社では日野セールスサポートの賃貸用設備合計 80,884が最大。在外はタイ 29,111 / インドネシア 10,803 / 米国 17,895。川崎・中津・富山・ポルトガルは本有報に非掲。設備投資 71,019（日本 48,708）。重要新設 40,000（日野市、2025-04〜2026-03、自己資本）。
- 出力: `llmwiki/sources/hino-ir-pass10.md`。index / WORKLOG / _meta / sources/integrated-report / topics/ifrs / sources/hino-ir / _last_run 更新。
