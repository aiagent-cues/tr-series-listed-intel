...
## 2026-09-07 JST 05:11 タイムボックス（1h分）
- 選定テーマ: 優先(1) 統合報告2025。登録頁に2026未掲。日PDF HEAD不変（35,488,119 / Last-Modified 2026-04-03 02:00:02 GMT）。(2) SDB sdb26_jp HEAD不変（11,691,278 / 2026-06-29 04:00:04 GMT）。(3) 20-Fは pass5と同一。PDF差替は無いが、第6パスが残した印刷p147販売店連携とp154 OMUSVIが未抽出のため(1)を継続。
- 実施: 統合報告2025日PDF（168p）から販売店コンプラ・OMUSVI・知財比率表を抽出。
- 新事実の核: 販売店全店舗総点検2020年から毎年6-8月、板金塗装2023追加、本部業務確認2024-04。OMUSVIは企画手書き→200桁製造→80桁営業の読み替えを共通言語化。知財2012登録はその他75/電動車14/電池7、2024出願中+登録は46/18/19。
- 出力: `llmwiki/sources/integrated-report-2025-pass7.md` 新設。index / WORKLOG / _meta / topics/esg / ai-development / scm 更新。
- 次: タテシナ参画企業名の図読み。(2)(3)(4)は差替PDF/掲出待ち。
...
- 選定テーマ: 優先(1) 統合報告2025。登録頁に2026未掲。日PDF HEAD不変（35,488,119 / Last-Modified 2026-04-03 02:00:02 GMT）。(2) SDB sdb26_jp HEAD不変（11,691,278 / 2026-06-29 04:00:04 GMT）。(3) 20-Fは 00:10 pass5と同一。(4) TMCA Past Reportsは403。PDF差替は無いが、p73-87・p132-138に未抽出の一次数値が残るため(1)を継続。
- 実施: 統合報告2025日PDF（168p）から液体水素・CN燃料・CE・SDV基盤・RAV4・119・WB実数を抽出。
- 新事実の核: 水素エンジン仲5→60社、連続30ラップ、raBit 2022-07/大熊2024-11、CN燃料4社2024-05、NTT合意2024-10・通信22倍/計算150倍、Arene SDK/Tools/Data、RAV4 EV150km・総1,350km・GR 320hp・累計1,500万台、e-Palette 2025-09 / L4は2027年度、WB SWLS 22.5→22.8・EG 60→64%。
...
- 新事実の核: R&D550億・特訑2,302・再エネ271,925MWh・水2,741千t。マテリアリティは2023-12特定。工場CO2は2013比▲60%。S1/S2/S3は12.4/8.4/4,835万t。FC実証4台で43万km・水素27t。古河SSA79件。女性管理職59人、男性育休73.6%。豪販社NSW議決権100%。
